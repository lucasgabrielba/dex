...
import type { OnboardingContentProps } from './content';
...
export type OnboardingLayoutProps = LayoutBaseProps & {
  layoutQuery?: Breakpoint;
  slotProps?: {
    header?: HeaderSectionProps;
    main?: MainSectionProps;
    content?: OnboardingContentProps;
  };
};
...
export function OnboardingLayout({
  ...
  const renderMain = () => (
    ...
    >
      <OnboardingContent {...slotProps?.content}>{children}</OnboardingContent>
    </MainSection>
  );
